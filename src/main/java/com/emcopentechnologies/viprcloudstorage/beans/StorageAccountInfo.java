/*
 Copyright 2013 EMC Open Technologies, Inc.
 ...
 */
package com.emcopentechnologies.viprcloudstorage.beans;
import org.kohsuke.stapler.DataBoundConstructor;

public class StorageAccountInfo {

	/** ViPR Cloud storage account name. */
	private String 			storageAccName;

	/** ViPR cloud storage account primary access key. */ 
	private String 			storageAccountKey;

	/** ViPR Cloud stoarge blob end point url. */

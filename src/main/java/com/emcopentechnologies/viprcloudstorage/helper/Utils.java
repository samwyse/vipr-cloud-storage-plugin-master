 ...
 */
package com.emcopentechnologies.viprcloudstorage.helper;
...
public class Utils {
	...
	public static final String DEF_BLOB_URL = "http://blob.core.vipr.net/";
	 ...
	 * 
	 * @param containerName
	 *            Name of the ViPR Cloud storage container
